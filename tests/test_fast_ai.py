"""Tests for FastAIPlayer adapter."""
...
class TestFastAIPlayer:
    """Test FastAIPlayer adapter class."""

    def test_create_fast_ai(self):
        """Test creating a FastAIPlayer."""
        ai = FastAIPlayer()
