...
class FastAIPlayer(AIPlayer):
    ...
    def _get_improved_default_params() -> Dict:
        ...
        return {
            ...
            "score_w": 15.0,  # Strong reward for line clears
    ...
    def _improved_heuristic_evaluation(self, playfield: list, lines_cleared: int) -> float:
        ...
        if cache_key in self._eval_cache:
            ...
            return cached_score + lines_cleared * self.params["score_w"]
        ...
        # Clear rewards (strongly prioritize clears)
        ...
        if len(self._eval_cache) < 10000:
            self._eval_cache[cache_key] = eval_score - lines_cleared * self.params["score_w"]
